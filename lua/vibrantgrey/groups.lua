...
function M.createGroups()
  ...
  Group.new('DiffAdd', colors.none, colors.green:dark(0.4))
  Group.new('DiffChange', colors.none, colors.blue:dark(0.1))
  Group.new('DiffDelete', colors.none, colors.red:dark(0.1))
  Group.new('DiffText', colors.none, colors.blue:dark(0.2))
